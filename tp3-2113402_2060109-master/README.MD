...
| Qualité et clarté du code                         |    0.75     |     2      |
| **Total**                                         | **18.25**    |   **20**   |

# Commentaires :
- Tests Nightwatch echouent...
- > Missing space before opening brace (-0.25pts)
- > No magic number: 200. (-0.25pts)
- > Trailing spaces not allowed (-0.25pts)
- > Missing space before value for key 'value' (-0.25pts)
- > 'field' is never reassigned. Use 'const' instead (-0.25pts)
- Structure code (-0.5pts)
- searchFields n'est pas iterable... (-1 pts)